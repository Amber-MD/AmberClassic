...
STRING          sTemp;
    ...
    if ( bAtomPerturbed( aAtom ) ) {
        ...
        /* Warn if the atom has a perturbation type but no pert name */
        ...
        /* Warn if the atom has a pert name but no pert type */
        ...
        /* Warn for each bond that was made through a distance search */

        /* Warn if the atoms type was calculated using CALCTYPES */
}
