...
static void assignav()
{
    ...
    for (i = 0; i < atomnum; i++) {
        ...
        if (atom[i].atomicnum == 6 && atom[i].connum == 3) {
            if (atom[atom[i].con[0]].atomicnum == 8 && atom[atom[i].con[0]].connum == 1)
                index1++;
            if (atom[atom[i].con[1]].atomicnum == 8 && atom[atom[i].con[1]].connum == 1)
                index1++;
            if (atom[atom[i].con[2]].atomicnum == 8 && atom[atom[i].con[2]].connum == 1)
                index1++;
            if (atom[atom[i].con[0]].atomicnum == 16 && atom[atom[i].con[0]].connum == 1)
                index1++;
            if (atom[atom[i].con[1]].atomicnum == 16 && atom[atom[i].con[1]].connum == 1)
                index1++;
            if (atom[atom[i].con[2]].atomicnum == 16 && atom[atom[i].con[2]].connum == 1)
                index1++;
        }
        if (atom[i].atomicnum == 15 && atom[i].connum == 4) {
            ...
            if (atom[atom[i].con[2]].atomicnum == 8 && atom[atom[i].con[2]].connum == 1)
                index2++;
            if (atom[atom[i].con[3]].atomicnum == 8 && atom[atom[i].con[3]].connum == 1)
                index2++;
            if (atom[atom[i].con[0]].atomicnum == 16 && atom[atom[i].con[0]].connum == 1)
                index2++;
            if (atom[atom[i].con[1]].atomicnum == 16 && atom[atom[i].con[1]].connum == 1)
            ...
            if (atom[atom[i].con[2]].atomicnum == 16 && atom[atom[i].con[2]].connum == 1)
                index2++;
            if (atom[atom[i].con[3]].atomicnum == 16 && atom[atom[i].con[3]].connum == 1)
                index2++;
        }
...
/* for N1- */
        if (atom[i].atomicnum == 7 && atom[i].connum == 1) {
            if (atom[atom[i].con[0]].atomicnum == 7 && atom[atom[i].con[0]].connum == 2)
                index4 = 1;
        }
/* for N2+ */
        if (atom[i].atomicnum == 7 && atom[i].connum == 2) {
            if ((atom[atom[i].con[0]].atomicnum == 7
                 || atom[atom[i].con[0]].atomicnum == 6)
                && atom[atom[i].con[0]].connum == 1)
                index5 = 1;
            if ((atom[atom[i].con[1]].atomicnum == 7
                 || atom[atom[i].con[1]].atomicnum == 6)
...
/* for O1- */
        if (atom[i].atomicnum == 8 && atom[i].connum == 1)
            if (atom[atom[i].con[0]].atomicnum == 7 && atom[atom[i].con[0]].connum == 3) {
                con1 = atom[atom[i].con[0]].con[0];
                con2 = atom[atom[i].con[0]].con[1];
                con3 = atom[atom[i].con[0]].con[2];
                if (atom[con1].atomicnum == 8 && atom[con1].connum == 1)
                    index8++;
                if (atom[con2].atomicnum == 8 && atom[con2].connum == 1)
                    index8++;
                if (atom[con3].atomicnum == 8 && atom[con3].connum == 1)
                    index8++;
                if (atom[con1].atomicnum == 16 && atom[con1].connum == 1)
                    index8++;
                if (atom[con2].atomicnum == 16 && atom[con2].connum == 1)
                    index8++;
                if (atom[con3].atomicnum == 16 && atom[con3].connum == 1)
                    index8++;
                if (index8 <= 1)
                    index8 = 1;
                else
...
*/
        ...
        for (;;) {
            if (fgets(line, MAXCHAR, fp) == NULL)
                break;
            if ((strncmp("APS", line, 3) == 0 && index1 < 2 && index2 < 2 && index3 < 2
                 && index4 < 1 && index5 < 1 && index6 < 2 && index7 < 1 && index8 < 1
                 && index9 < 1 && index10 < 1)
                ...
                sscanf(&line[7], "%s%d%s%s%s%s%s%s%s%s%s", tmpc1, &tmpint, tmpc2, tmpc3,
                       tmpc4, tmpc5, tmpc6, tmpc7, tmpc8, tmpc9, tmpc10);
                if (tmpint == atom[i].atomicnum
                    && (tmpc2[0] == '*' || atoi(tmpc2) == atom[i].connum)) {
                    if (tmpc3[0] == '*')
                        av[i].aps[0] = 9999;
                    else
    ...
    if (debug) {
        ...
        for (i = 0; i < atomnum; i++)
            printf("\n%4d%5s%5d%5d%5d%5d%5d%5d%5d%5d%5d%5d", i + 1, atom[i].name,
                   atom[i].atomicnum, atom[i].connum, av[i].aps[0], av[i].aps[1],
                   av[i].aps[2], av[i].aps[3], av[i].aps[4], av[i].aps[5], av[i].aps[6],
                   av[i].aps[7]);
    }
    maxaps = 0;
    for (i = 0; i < atomnum; i++) {
        ...
        if (index == 0) {
            if (iaps == 0)
                printf("Warning: For atom (ID: %d, Name: %s) the best APS is not zero.\n"
                       "         Bonds involving this atom are frozen.\n",
                       i + 1, atom[i].name);
            else if (iaps == 1) {
                eprintf("For atom (ID: %d, Name: %s) the best APS is not zero.", i + 1,
                       atom[i].name);
            }
        }
    }
...
{
    atom2 = (ATOM *) emalloc(sizeof(ATOM) * atomsize);
    bond2 = (BOND *) emalloc(sizeof(BOND) * bondsize);
    int i;
    for (i = 0; i < bondsize; ++i) {
        bond2[i].jflag = -1;    /* bond type has not been assigned */
    }

    av2 = (AV *) emalloc(sizeof(AV) * atomsize);
    valence2 = (int *) emalloc(sizeof(int) * atomsize);
    va_best2 = (int *) emalloc(sizeof(int) * atomsize);
    apstype2 = (int *) emalloc(sizeof(int) * atomsize);
    con_num = (int *) emalloc(sizeof(int) * atomsize);
    ind_bondnum = (int *) emalloc(sizeof(int) * atomsize);
    ind_valence = (int *) emalloc(sizeof(int) * atomsize);
    bondindex = (int *) emalloc(sizeof(int) * bondsize);
    bondindex_bak = (int *) emalloc(sizeof(int) * bondsize);
    bondtype_bak = (int *) emalloc(sizeof(int) * bondsize);
}
...
static void current_va(int id)
{
    int i;
    if (debug) {
        printf("\n\nThe current valence state (%d) is listed as the following", id);
    ...
    while (index > 0) {
        ...
        for (i = 0; i < atomnum2; i++)
            if ((ind_bondnum[i] == 1 && ind_valence[i] > 0)
                || ((ind_bondnum[i] == ind_valence[i]) && ind_valence[i] != 0))
                for (j = 0; j < atom2[i].connum; j++) {
                    ...
                    for (k = 0; k < bondnum2; k++) {
                        ...
                        if ((bond2[k].bondi == at1 && bond2[k].bondj == at2)
                            || (bond2[k].bondi == at2 && bond2[k].bondj == at1)) {
...
/*first assume it is a single bond */
        ...
        for (i = 0; i < bondnum2; i++)
            if (bondindex[i] == -1) {
                ...
                if (debug == 1) {
                    for (k = 0; k < bondnum2; k++)
                        printf("\nsingle_b%5s%5s%5d", atom2[bond2[k].bondi].name,
                               atom2[bond2[k].bondj].name, bond2[k].type);
                    for (k = 0; k < atomnum2; k++)
                        printf("\nsingle_a%5s%5d%5d%5d%5d", atom2[k].name, ind_bondnum[k],
                               con_num[k], ind_valence[k], valence2[k]);
                    printf("\nsingle %5d %5s %5s %5d", i + 1, atom2[at1].name,
                           atom2[at2].name, score);
                }
                flag = 0;
                for (k = 0; k < bondnum2; k++)
                    if (bond2[k].type == -1)
                ...
                if (score > 0) {        /*error happens, bond type is set to 2 */
                    ...
                    if (debug == 1) {
                        for (k = 0; k < bondnum2; k++)
                            printf("\ndouble_b%5s%5s%5d", atom2[bond2[k].bondi].name,
                                   atom2[bond2[k].bondj].name, bond2[k].type);
                        for (k = 0; k < atomnum2; k++)
                            printf("\ndouble_a%5s%5d%5d%5d%5d", atom2[k].name,
                                   ind_bondnum[k], con_num[k], ind_valence[k],
                                   valence2[k]);
                        printf("\ndouble %5d %5s %5s %5d", i + 1, atom2[at1].name,
                               atom2[at2].name, score);
                    }
                    flag = 0;
                    for (k = 0; k < bondnum2; k++)
    ...
    for (i = -1; i < vastatenum; i++) {
        ...
        if (fail_flag == 0) {
            if (debug) {
                ...
                for (j = 0; j < bondnum2; j++) {
                    if (bond2[j].type2 < 0)
                        printf("\n%5d%5d%5d%5d", j + 1, bondindex[j], bond2[j].type, -1);
                    else
                        printf("\n%5d%5d%5d%5d", j + 1, bondindex[j], bond2[j].type,
                               org_bondtype[bond2[j].type2]);
                }
            }
            for (j = 0; j < bondnum2; j++)
                if (bond2[j].type2 != -1)
            ...
            if (i != -1)
                printf("Info: Bond types are assigned for valence state (%d) with penalty (%d).\n",
                       i + 1, va_penalty[i]);
            return 1;
        }
    }
...
/*part3*/
        if ((atom[bondi].connum == 2 || atom[bondi].connum == 3)
            ...
            && ((atom[bondj].connum == 1 && atom[bondj].atomicnum == 8)
                || (atom[bondj].connum == 1 && atom[bondj].atomicnum == 16))) {
            for (j = 0; j <= 5; j++) {
                ...
                if (atom[atom[bondi].con[j]].connum == 1
                    && (atom[atom[bondi].con[j]].atomicnum == 8
                        || atom[atom[bondi].con[j]].atomicnum == 16))
                    bond[i].type = 6;
                break;
            }
            if (bond[i].type == 6)
        ...
        if ((atom[bondj].connum == 2 || atom[bondj].connum == 3)
            ...
            && ((atom[bondi].connum == 1 && atom[bondi].atomicnum == 8)
                || (atom[bondi].connum == 1 && atom[bondi].atomicnum == 16))) {
            for (j = 0; j <= 5; j++) {
                ...
                if (atom[atom[bondj].con[j]].connum == 1
                    && (atom[atom[bondj].con[j]].atomicnum == 8
                        || atom[atom[bondj].con[j]].atomicnum == 16))
                    bond[i].type = 6;
                break;
            }
            bond[i].type = 6;
        ...
        if (atom[i].connum == 3 && atom[i].atomicnum == 16) {
            ...
            for (j = 0; j <= 2; j++) {
                ...
                if (atom[bondi].connum == 1
                    && (atom[bondi].atomicnum == 8 || atom[bondi].atomicnum == 16)) {
                    num++;
                    index[j] = 1;
                }
            }
            if (num == 2)
                for (j = 0; j < bondnum; j++) {
                    ...
                    bondj = bond[j].bondj;
                    for (k = 0; k <= 2; k++)
                        if (index[k] == 1 && ((bondi == i && bondj == atom[i].con[k])
                                              || (bondj == i && bondi == atom[i].con[k])))
                            bond[j].type = 9;
                }
        }
...
static void va_arrays_filler(size_t npairs, const ncsu_penalty_pair_t * pairs, void *data)
{
    size_t n;
    size_t **points;
    ...
    if (vastatenum == va_allocated) {
        ...
        va_valence = (int **) ncsu_realloc(va_valence, va_allocated * sizeof(int *));
    ...
    for (n = 0; n < npairs; ++n) {
        ...
        size_t_to_point(points[p][o], va_addr[vastatenum] + n,
                        va_valence[vastatenum] + n);
        va_penalty[vastatenum] += (int) p;

        if (debug)
            printf(" (%d, %d, %d)", va_addr[vastatenum][n], (int) p,
                   va_valence[vastatenum][n]);
    }
...
static void process(void)
{
    ...
    for (m = 1; m < maxaps + 1; ++m) {
        ...
        points[m] =
            (npoints[m] ==
             0 ? NULL : (size_t *) ncsu_malloc(sizeof(size_t) * npoints[m]));
    }
    ...
    for (m = 1; m <= maxaps; ++m) {
        ...
        if (debug)
            printf("\nThe number of unduplicated VA states are %d so far", vastatenum);
    }                           /* for (m = 1; m <= maxaps; ++m) */
    ...
    if (debug) {
        ...
        for (i = 0; i < vastatenum; ++i)
            for (j = 0; j < va_num[i]; ++j)
                printf("\n%5d%5d%5d%5d%5d", i + 1, j + 1, va_penalty[i], va_addr[i][j],
                       va_valence[i][j]);
    }
  ...
  judge:
    if (judgebt() == 0) {
        printf( "Warning: The assigned bond types may be wrong, please :\n"
...
int main(int argc, char *argv[])
{
    ...
    for (i = 1; i < argc; i += 2) {
        ...
        if (strcmp(argv[i], "-f") == 0) {
            if (strcmp(argv[i + 1], "ac") == 0 || strcmp(argv[i + 1], "AC") == 0)
                iformat = 1;
            if (strcmp(argv[i + 1], "mol2") == 0 || strcmp(argv[i + 1], "MOL2") == 0)
                iformat = 2;
            continue;
        }
        if (strcmp(argv[i], "-j") == 0) {
            if (strcmp(argv[i + 1], "full") == 0 || strcmp(argv[i + 1], "Full") == 0
                || strcmp(argv[i + 1], "FULL") == 0)
                judge_flag = 1;
            if (strcmp(argv[i + 1], "part") == 0 || strcmp(argv[i + 1], "Part") == 0
        ...
        if (strcmp(argv[i], "-s") == 0) {
            iaps = atoi(argv[i + 1]);
            if (iaps != 0 && iaps != 1) {
                printf("Warning: -s flag must be 0 or 1.\n");
                break;
            }
            continue;
        }
    ...
    arom = (AROM *) emalloc(sizeof(AROM) * cinfo.maxatom);
...
/* allocate memory for org_bondtype, av, valence, va_best, conjatom, seq and res*/
    org_bondtype = (int *) emalloc(sizeof(int) * bondnum);
    av = (AV *) emalloc(sizeof(AV) * atomnum);
    valence = (int *) emalloc(sizeof(int) * atomnum);
    va_best = (int *) emalloc(sizeof(int) * atomnum);
    conjatom = (int *) emalloc(sizeof(int) * atomnum);
    seq = (int *) emalloc(sizeof(int) * atomnum);
    apstype = (int *) emalloc(sizeof(int) * atomnum);
    res = (RES *) emalloc(sizeof(res) * MAXRES);
...
/*find maximum atomnum and bondnum in a residue */
    ...
    for (i = 0; i < atomnum; i++) {
        if (atom[i].resno != resno) {
            ...
            resnum++;
            if (resnum == MAXRES) {
                res = (RES *) erealloc(res, sizeof(RES) * (MAXRES + resnum));
            }
        }
    }
    if (debug)
...
/* adjust the bonded atoms atom[].con[], delete neighbours that belong to other residues */
        for (j = 0; j < atomnum2; j++) {
            ...
            for (k = 0; k < 6; k++) {
                if (atom2[j].con[k] == -1)
                    continue;
                if (atom[atom2[j].con[k]].resno != res[i].resno)
                    continue;
...
/* create a new atom H*/
                ...
                atom2[bond2[bondnum2].bondi].con[atom2[bond2[bondnum2].bondi].connum] =
                    atomnum2;
...
/* create a new atom H*/
                ...
                atom2[atomnum2].con[4] = -1;
                atom2[atomnum2].con[5] = -1;
                atom2[bond2[bondnum2].bondj].con[atom2[bond2[bondnum2].bondj].connum] =
                    atomnum2;
...
/* there are other cases that jflag reads in from the input file*/
            if (bond2[j].jflag == 1) {
                ...
                if (bond2[j].type != 1 && bond2[j].type != 2 && bond2[j].type != 3
                    ...
                    eprintf("The frozen atom type can only be 1, 2, 3, 7 (aromatic single),\n"
