...
#ifndef TYPESRISM3D_H
#define TYPESRISM3D_H
...
struct s_RIS_SHROUD_capsule_data {
    void *addr;     /* address of C++ memory */
    int idtor;      /* index of destructor */
};
typedef struct s_RIS_SHROUD_capsule_data RIS_SHROUD_capsule_data;
...
struct s_RIS_SHROUD_array {
    RIS_SHROUD_capsule_data cxx;      /* address of C++ memory */
    union {
        const void * base;
        const char * ccharp;
    } addr;
...
typedef struct s_RIS_SHROUD_array RIS_SHROUD_array;

// helper capsule_RIS_rism3d_c_rism3d
struct s_RIS_rism3d_c_rism3d {
    void *addr;     /* address of C++ memory */
    int idtor;      /* index of destructor */
};
typedef struct s_RIS_rism3d_c_rism3d RIS_rism3d_c_rism3d;
